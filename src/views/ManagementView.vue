...
<style scoped>
  ...
  .btn-sync { 
    background: #42b983; color: white; border: none; padding: 10px 15px; border-radius: 4px; cursor: pointer; 
  }
  .btn-sync:disabled { 
    background: #ccc; 
  }
  .input-search { 
    padding: 8px; width: 300px; margin-bottom: 15px; 
  }
  .data-table { 
  ...
  .badge { 
    background: #e0f2f1; color: #00796b; padding: 4px 8px; border-radius: 12px; font-size: 0.8em; 
  }
  .btn-delete { 
    background: #ff5252; color: white; border: none; padding: 5px 10px; border-radius: 3px; cursor: pointer; 
  }
</style>